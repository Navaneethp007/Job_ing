...
class Findlog extends StatefulWidget {
  const Findlog({Key? key}) : super(key: key);

  @override
  _FindlogState createState() => _FindlogState();
}
class _FindlogState extends State<Findlog> {
  @override
